...
% Author: Hugo Pereira
% Template available on Github: github.com/hugopereira-eng
...
%        \ItemWithoutTitle{The Workshop Rockets consists of a theoretical part in which concepts such as stability, center of gravity, and center of pressure are addressed. And a second part of planning, building, and launching the rocket. In short, this project aims to promote the passion for space among youngsters; Target audience: high schools and college students; Gave six sessions in total.}
...
\ItemListStart
        ...
        %  The system goes aboard the company's UAVs, being used for rescue missions.
%        \ItemWithoutTitle{Helped in the manufacture of some parts of the UAV.}
\ItemListEnd
